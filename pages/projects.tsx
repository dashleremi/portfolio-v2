            ...
            <div className='grid grid-cols-1 items-start mx-auto rounded-md'>
                ...
                <div className='grid grid-cols-1 items-center justify-center my-10'>
                    <div className='glassmorphism-container flex items-center justify-between'>
                        ...
                        <Image src="/homepage.png" alt="" className='mr-3 opacity-50 hover:opacity-100 transition-all duration-500 p-5' width={500} height={450}/>
                    </div>
                    <div className='glassmorphism-container flex items-center justify-between pt-5'>
                        ...
                        <Image src="/ggc-hp.png" alt="" className='mr-3 opacity-50 hover:opacity-100 transition-all duration-500 p-5' width={500} height={200}/>
                    </div>
                </div>

                <div className='grid grid-cols-1 items-start mx-auto rounded-md'>
                    <p className='mt-20 text-2xl uppercase font-bold'>Product Design</p>
                </div>
                ...
                <div className='grid grid-cols-2 items-center justify-center mt-20 gap-10'>
                    ...
                    <div className='glassmorphism-container'>
                        ...
                        <p>Rack Up Miles, Rise on the Leaderboard, and Relive Every Adventure!</p>
                    </div>
                    </Link>
                    <div className='glassmorphism-container'>
