        ...
        <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-black">
          ...
          <div className="flex flex-row-reverse md:contents">
            <div className="bg-[#d1d1d12b] col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-sm">
              ...
              <a href="/project1"><img src="j-intl.png" alt="" className="hover:scale-150 transition-all duration-500" /></a>
            </div>
          ...
          <div className="flex md:contents">
            ...
            <div className="bg-[#d1d1d12b] col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-sm">
              ...
              <a href="/project2"><img src="cem.png" alt="" className="hover:scale-150 transition-all duration-500" /></a>
            </div>
          </div>
          ...
          <div className="flex flex-row-reverse md:contents">
            <div className="bg-[#d1d1d12b] col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-sm">
              ...
              <a href="/project3"><img src="ssh.png" alt="" className="hover:scale-150 transition-all duration-500"/></a>
            </div>
            <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
              <div className="h-full w-6 flex items-center justify-center">
                <div className="h-full w-1 bg-[#dadada74] pointer-events-none"></div>
          ...
          <div className="flex md:contents">
            ...
            <div className="bg-[#d1d1d12b] col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-sm">
              ...
              <a href="/project4"><img src="anthro-hp.png" alt="" className="hover:scale-150 transition-all duration-500" /></a>
            </div>
          </div>
        </div>
      </div>
